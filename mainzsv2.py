...
def doTheJob():
	...
	questionBox = [20,150,710,200]
	questionSubImage = testImage.crop(Box2Rect(questionBox, scaleSize))

	answerABox = [80,365,575,100] # x,y,w,h
	answerASubImage = testImage.crop(Box2Rect(answerABox, scaleSize))

	answerBBox = [80,answerABox[1] + 35 + answerABox[3],answerABox[2],answerABox[3]]
	answerBSubImage = testImage.crop(Box2Rect(answerBBox, scaleSize))

	answerCBox = [80,answerABox[1] + (35 + answerABox[3]) * 2,answerABox[2],answerABox[3]]
