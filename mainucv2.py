...
def doTheJob():
	...
	questionBox = [50,250,655,200]
	questionSubImage = testImage.crop(Box2Rect(questionBox, scaleSize))

	answerABox = [130,455,530,105] # x,y,w,h
	answerASubImage = testImage.crop(Box2Rect(answerABox, scaleSize))

	answerBBox = [130,answerABox[1] + 45 + answerABox[3],answerABox[2],answerABox[3]]
	answerBSubImage = testImage.crop(Box2Rect(answerBBox, scaleSize))

	answerCBox = [130,answerABox[1] + (45 + answerABox[3]) * 2,answerABox[2],answerABox[3]]
